...
class TestTrackingBenchmark(arvet.database.tests.test_entity.EntityContract, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.tracking_states = {
            ...
            2: tracking_state.TrackingState.OK,
            2.3333: tracking_state.TrackingState.LOST,
            2.6667: tracking_state.TrackingState.LOST,
            ...
            4.3333: tracking_state.TrackingState.OK,
            4.6667: tracking_state.TrackingState.LOST
        }
