...
class TrackingComparisonResult(arvet.core.trial_comparison.TrialComparisonResult):
    """
    ...
    def is_lost(self, state):
        return state is tracking_state.TrackingState.LOST or (
            self.initializing_is_lost and state is tracking_state.TrackingState.NOT_INITIALIZED)
